					...
					<div className="homepage-container">
						<div className="homepage-content">
							...
							<div className="right-border">
								...
								<div className="category-list">
									<ul>
										<li className={activeCategory === 0 ? "active" : ""} onClick={() => categoryHandler(null, true)}>
											All
										</li>
										{!isEmptyCategory &&
											categories.results.map((c) => (
												<li className={activeCategory === c.id ? "active" : ""} onClick={() => categoryHandler(c)} key={c.id} to="#">
													{c.name}
												</li>
											))}
									</ul>
						...
						<div className="homepage-content">
							...
							{!isEmptyProduct ? (
								category.name && !type ? (
									<>
										{femaleProduct.length > 0 && <ProductListCard labelType={Female} products={femaleProduct} carts={carts.results} />}
										{maleProduct.length > 0 && <ProductListCard labelType={Male} products={maleProduct} carts={carts.results} />}
									</>
								) : (
